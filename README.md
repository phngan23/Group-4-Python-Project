...
| **Trần Khánh Linh**<br/>*(Frontend Developer)* | 11245897 | UI Development &<br/>User Experience | • Implemented responsive Web Interface designs<br/>• Developed Dark/Light Mode toggle feature | 16.66% |
| **Chu Bá Thông**<br/>*(Backend Developer)* | 11245935 | Data Visualization &<br/>Analytics Engine | • Engineered Data Visualization engine<br/>• Developed statistical algorithms & Analytics charts (Study Session % Emotion Tracking) | 16.66% |
