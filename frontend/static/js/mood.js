...
function renderEmotionDistribution() {
  ...
  distributionElement.innerHTML = distribution
    .map((item) => {
...
function renderMoodStats() {
  ...
  const mostFrequentMoodConfig = moods.find(
    (m) => m.value === stats.most_frequent_emotion
  );
  ...
  statsElement.innerHTML = `
        ...
        <div class="stat-item">
            ...
            <div class="stat-value">
                ${
                  mostFrequentMoodConfig
                    ? mostFrequentMoodConfig.emoji +
                      " " +
                      mostFrequentMoodConfig.label
                    : "No data"
                }
            </div>
            <div class="stat-desc">
                ${
                  stats.most_frequent_count
                    ? `Appeared ${stats.most_frequent_count} times`
